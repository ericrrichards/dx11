...
namespace BoxDemo {
    ...
    public class BoxApp : D3DApp {
        ...
        private void BuildGeometryBuffers() {
            ...
            var vbd = new BufferDescription(Vertex.Stride*vertices.Length, ResourceUsage.Immutable, BindFlags.VertexBuffer, CpuAccessFlags.None, ResourceOptionFlags.None, 0);
            ...
            var ibd = new BufferDescription(sizeof (uint)*indices.Length, ResourceUsage.Immutable, BindFlags.IndexBuffer, CpuAccessFlags.None, ResourceOptionFlags.None, 0);
        ...
        private void BuildFX() {
            ...
            try {
                compiledShader = ShaderBytecode.CompileFromFile("FX/color.fx", null, "fx_5_0", shaderFlags, EffectFlags.None, null, null, out errors);
